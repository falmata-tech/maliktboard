...
| Portable PR quality gate | MP-05, MP-46, MP-49 | N/A | N/A | DEP-001 | N/A | `.github/workflows/quality.yml`, portable `package-lock.json`; protected `main` | PR #1 hosted checks pass; strict required checks, PRs, admin enforcement, resolved conversations, no force-push/deletion verified | done |
