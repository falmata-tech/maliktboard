...
| Application-service authorization enforcement | BE-001 finding; architecture contract | N/A | BE-002 | TBD | ADR-001 | Not implemented | Static inspection: route checks exist, protected services do not consistently enforce role capabilities; bare evidence accessor is unscoped | proposed |
